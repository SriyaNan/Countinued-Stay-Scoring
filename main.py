...
SAMPLES={"Approve — SUD Residential":("sud","residential",9,14,[3,3,1,2,3,3,3,1,3,2]),"Borderline — MH PHP":("mh","php",16,10,[1,0,1,1,3,1,2,1,1,1]),"High denial risk — SUD IOP":("sud","iop",40,21,[0,0,0,0,3,0,0,1,2,0])}
